...
#ifndef NEFTAPLUGIN_IOS_SWIFT_H
#define NEFTAPLUGIN_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NeftaPlugin_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15NeftaPlugin_iOS11BidResponse")
...
SWIFT_CLASS("_TtC15NeftaPlugin_iOS6Events")
...
SWIFT_CLASS("_TtC15NeftaPlugin_iOS11NeftaPlugin")
...
- (NSString * _Nullable)GetUser SWIFT_WARN_UNUSED_RESULT;
- (void)SetUserWithJson:(NSString * _Nonnull)json;
...
SWIFT_CLASS("_TtC15NeftaPlugin_iOS15NeftaPlugin_iOS")
...
@property (nonatomic) BOOL _autoLoad;
...
SWIFT_CLASS("_TtC15NeftaPlugin_iOS14VideoPlacement")
...
SWIFT_CLASS("_TtCC15NeftaPlugin_iOS14VideoPlacement8Creative")
...
SWIFT_CLASS("_TtCC15NeftaPlugin_iOS14VideoPlacement9MediaFile")
...
@interface WebController : NSObject <WKNavigationDelegate>
...
SWIFT_CLASS("_TtC15NeftaPlugin_iOS12WebPlacement")
