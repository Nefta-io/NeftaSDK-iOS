var mraid = {
    ...
    _resizeObject: null,
    _exp: 0,
    _eventListeners: {"ready":[],"error":[],"sizeChange":[],"stateChange":[],"exposureChange":[],"audioVolumeChange":[]},
    ...
    getMaxSize: function(){return{"width":window.MRAID_ENV._p.width,"height":window.MRAID_ENV.height}},
...
window.addEventListener("DOMContentLoaded", function() { mraid._state = "default";
    mraid._eventListeners["ready"].forEach(f => f());
    mraid._eventListeners["stateChange"].forEach(f => f("default")) });
