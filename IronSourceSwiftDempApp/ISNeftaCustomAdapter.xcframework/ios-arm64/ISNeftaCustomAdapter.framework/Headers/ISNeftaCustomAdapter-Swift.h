...
#ifndef ISNEFTACUSTOMADAPTER_SWIFT_H
#define ISNEFTACUSTOMADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ISNeftaCustomAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20ISNeftaCustomAdapter11BidResponse")
...
SWIFT_CLASS_NAMED("ISNeftaCustomAdapter")
...
SWIFT_CLASS_NAMED("ISNeftaCustomBanner")
...
SWIFT_CLASS_NAMED("ISNeftaCustomInterstitial")
...
SWIFT_CLASS_NAMED("ISNeftaCustomRewardedVideo")
...
SWIFT_CLASS("_TtC20ISNeftaCustomAdapter11NeftaEvents")
...
SWIFT_CLASS("_TtC20ISNeftaCustomAdapter11NeftaPlugin")
...
SWIFT_CLASS("_TtC20ISNeftaCustomAdapter15NeftaPlugin_iOS")
...
- (void)InitWithAppId:(NSString * _Nullable)appId useMessages:(BOOL)useMessages;
- (void)PrepareRendererWithUiView:(UIView * _Nonnull)uiView;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20ISNeftaCustomAdapter9Placement")
...
SWIFT_CLASS("_TtC20ISNeftaCustomAdapter14VideoPlacement")
...
SWIFT_CLASS("_TtCC20ISNeftaCustomAdapter14VideoPlacement8Creative")
...
SWIFT_CLASS("_TtCC20ISNeftaCustomAdapter14VideoPlacement9MediaFile")
...
SWIFT_CLASS("_TtC20ISNeftaCustomAdapter12WebPlacement")
